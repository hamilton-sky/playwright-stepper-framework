...
| 2 | 2 | Local heal cache — HealCache class + wire into StepRunner | TODO | cache HIT on second run of same broken workflow |
...
| 2 | Heal Cache | Engine | Persistent per-site JSON cache, checked before cascade | 2 | TODO | `engine/healer/healing_cache.py`, `engine/runner/step_runner.py` |
