...
| 3 | 6 | Hook Self-Correction + Error Handling sections | TODO | `grep -q "Hook Self-Correction" .claude/skills/generate-poms/SKILL.md` |
| 4 | 7 | Fixture trace + end-to-end smoke test on a temp `gen_sd` site | TODO | `claude -p "/verify-layers"` reports zero violations on generated `gen_sd` site |
...
| 6 | Hook awareness + error handling | Skill body | Append "Hook Self-Correction" + "Error Handling" sections | 3 | TODO | `.claude/skills/generate-poms/SKILL.md` |
| 7 | E2E smoke test | Verification | Hand-craft fixture trace, run skill, verify generated `gen_sd` site passes verify-layers and imports | 4 | TODO | `plans/generate-poms-skill/fixtures/saucedemo_trace.json` (committed); `poms/gen_sd/`, `stepper/sites/gen_sd/` (test artefacts, not committed) |
