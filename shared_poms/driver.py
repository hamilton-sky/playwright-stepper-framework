"""
driver.py — Playwright isolation wrapper.
...
Pattern: Adapter
  IBrowserDriver  — the interface (in shared_poms/interfaces.py)
...
from shared_poms.interfaces import IBrowserDriver, IElementHandle
...
class PlaywrightDriver(IBrowserDriver):
    ...
    DIP: Only api.py (the wiring point) instantiates this class.
    ...
    async def fill(self, selector: str, value: str, *, timeout: int = 5_000) -> None:
