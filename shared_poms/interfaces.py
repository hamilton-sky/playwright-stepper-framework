"""
interfaces.py — POM and browser driver contracts.

These interfaces define the browser driver adapter and configuration
contracts used by Page Object Models.

Concrete implementations:
  IBrowserDriver  → shared_poms/driver.py:PlaywrightDriver
  IElementHandle  → shared_poms/driver.py:PlaywrightElementHandle
"""
...
class IElementHandle(ABC):
    ...
    Concrete: PlaywrightElementHandle in shared_poms/driver.py
    """
...
class IBrowserDriver(ABC):
    ...
    Concrete: PlaywrightDriver in shared_poms/driver.py
