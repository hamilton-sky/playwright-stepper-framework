<!--
  ...
  A static reading of the starter script the exam supplied, from the project's
  first week. It is kept beside the suite that replaced that script: this
  directory was called `exam/` when this was written.

  The design narrative it belongs to is docs/exam-submission.md.
-->
